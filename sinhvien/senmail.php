		...
		<div class="right">
			<div class="field">
				...
				<form method="POST" id="senmail"> 
                            ...
                            <div class="message">
                            Vui lòng nhập địa chỉ email mà nhà trường cung cấp. Một Email sẽ tự động gửi vào hộp thư điện tử của bạn, hãy theo các hướng dẫn trong email để thiết lập lại mật khẩu.
