    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header" style="color: white;">
                <img src="images/cnweb.png" height="70px" width="150px">
...
<nav class="navbar navbar-expand-lg " style="background-color: #7386D5;height: 40px;margin-top: -40px;margin-left: -40px;width: 1110px;">
    ...
    <div class="tb1">
        <div class="anh"><img src="images/pic1.png" style="width: 100%;height: 100%;"></div>
    ...
    <div class="tb1">
        ...
        <div class="anh2" style="width: 350px;"><img src="images/pic2.png" style="width: 100%;height: 100%"></div>
    </div>
    <div class="tb1">
        <div class="anh3"><img src="images/pic3.png" style="width: 100%;height: 100%"></div>
        <div class="text">
