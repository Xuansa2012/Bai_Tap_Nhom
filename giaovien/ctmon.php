          ...
          $('#upload_csv').on("submit", function(e){ 
           ...
           $('#filebt').on("submit", function(e){ 
               ...
               if(a){
                    ...
                    if(a.indexOf('.pdf') > 0){
                          $.ajax({  
                               url:"ajax/daybt.php?file="+file+"&&date="date,     
                               success: function(a){
                                 //$('#"dayFileBT"').html(a);
                                 alert(a);
                              }
...
<nav class="navbar navbar-expand-lg " style="background-color: #7386D5;width: 100%;height: 50px;position: absolute;top:0;left:0">
    ...
    <div class="thanh">Giới thiệu môn học</div>
        ...
        <div style="margin-top:10px">
            <div class="thanh">danh sách bài tập</div>
            <div style="margin-top: 20px"></div>
            <form id="filebt" method="post" enctype="multipart/form-data">  
                <div class="row" style="margin-left: 20px">
                     <div class="col-md-4" style="text-align: right;margin-top: 20px;">bài tập</div> 
                     <div class="col-md-4">  
                          <input type="file" name="file_bt" style="margin-top:15px;" id="file_bt" /> 
                     </div> 
                 </div>
                 <div style="margin-top: 10px;"></div> 
                <div class="row" style="margin-left: 20px;margin-top: 10px;">
                    <div class="col-md-4" style="text-align: right">thời gian nộp bài</div>
                    <div class="col-md-4"><input type="date" name="date" id="date"></div> 
                </div> 
                 <div class="row" style="margin-left: 20px;margin-top: 10px;">
                    <div class="col-md-4" style="text-align: right"></div>
                     <div class="col-md-4"><input type="submit" name="uploadbt" id="uploadbt" value="Upload" style="margin-top:10px;" class="btn btn-info" /></div>  
                </div>
            </form>  
        </div>
        <div class="container-fluid" style="margin-top: 10px;"  id="dayFileBT">
                <?php 
