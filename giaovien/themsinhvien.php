<?php
	...
	if($hoTen!="" && $ngaySinh!=="" && $diaChi!="" && $email!="" && $soDT!=""){
	 ...
	 require_once('khungtrang/nav.php');
	 require_once('khungtrang/menutren.php');
?>
<style type="text/css">
		.kc-form-input{
			margin-top: 10px;
		...
		.dt1{width: 1050px;height:700px;background-color: #FAF0E6;margin-top: -20px;margin-left: -5px;}
    .thanh{width: 1050px;height: 40px;background-color: #6A5ACD;padding-top: 8px;padding-left: 10px;color: white;}
    form{word-wrap: 500px;height: 400px;margin-top: 30px;color: blue;margin-left: 150px;}
	</style>
...
<div class="dt1">
	<div class="thanh">Thêm người dùng
<form action="" id="form" method="post" enctype="multipart/form-data">	
	...
	<div class="row kc-form-input">
		...
		<div class="col-sm-4"><input type="text" class="form-control" id="diaChi" placeholder="Nhập đại chỉ" name="diaChi" value="<?php echo $diaChi?>"></div>
	...
	<div class="row kc-form-input">
		...
		<div class="col-sm-4"><input type="Email" class="form-control" id="email" placeholder="Nhập eamil" name="email" value="<?php echo $email?>"></div>
	...
	<div class="row kc-form-input">
		...
		<div class="col-sm-4"><input type="text" class="form-control" id="soDT" placeholder="Nhập Số điện thoại" name="soDT" value="<?php echo $soDT?>"></div>
	...
	<div class="row kc-form-input">
		...
		<div class="col-sm-4"><button type="submit" id="submit" class="btn btn-primary" style="margin-left: 70px;">Thêm</button></div>
		<div class="col-sm-5"></div>
	</div>
</form>
</div>
