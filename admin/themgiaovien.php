<?php
	...
	if($hoTen!="" && $ngaySinh!=="" && $diaChi!="" && $email!="" && $soDT!=""){
		...
		$sql="insert into nguoidung values('".$ma_sv."','".$img."','12345678','','".$hoTen."','".$ngaySinh."','".$gioiTinh."','".$diaChi."','".$email."','".$soDT."','gv')";
		xuly($sql);
			...
			<nav class="navbar navbar-expand-lg " style="background-color: #7386D5;width: 100%;height: 50px;position: absolute;top:0;left:0">
				<div class="container-fluid">
					<div class="navbar-header" style="position: absolute;:left: 0;">
						<a class="navbar-brand" href="index.php"><i class="fas fa-home"></i> Trang chủ / Thêm Giáo Viên</a>
					</div>    
			...
			<div class="than">
				<form action="" id="form" method="post" enctype="multipart/form-data">	
					...
					<div class="row kc-form-input">
						...
						<div class="col-sm-4" style="margin-left:100px;"><button type="submit" id="submit" class="btn btn-primary" style="margin-top: 15px;">Thêm</button></div>
						<div class="col-sm-5"></div>
					</div>
				</form>
			</div>
