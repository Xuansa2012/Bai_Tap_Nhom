	...
	<div class="wrapper" style="position: absolute;position: absolute;top :0">
		...
		<div id="content" style="width: 85%;">
			...
			<div class="than">
				...
				<div class="gt">
					<div class="sua"><a href="suamonhoc.php"><button type="submit"class="btn btn-primary"style="width: 100px;">Sửa</button></a></div>
					<div class="xoa"><a href="xoamonhoc.php"><button type="submit"class="btn btn-primary"style="width: 100px;">Xoá</button></a></div>
				</div>
