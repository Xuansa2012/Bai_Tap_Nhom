			...
			<div class="wrap-login100" style="height: 500px;">
				...
				<form class="login100-form validate-form" style="margin-top:-100px" id="dangnhap">
					...
					<div class="wrap-input100 validate-input" data-validate = " ">
						<input class="input100" type="text"name ="tk" id="form1Example13" placeholder="taikhoan"> 
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name ="pass" id="form1Example23" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
...
>>>>>>> e9609184b64e1d9fda7418f9e731a7db0fcbccaa
</html>