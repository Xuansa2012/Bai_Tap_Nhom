...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content" style="background-color: red;">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: pink;height: 40px;margin-top: -40px;margin-left: -40px;width: 1020px;">
                <div class="container-fluid">

                    <button type="button" id="sidebarCollapse" class="btn btn-info"style="margin-left: -25px;">
